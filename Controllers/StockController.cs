    ...
    public class StockController : Controller
    {
      ...
      public IActionResult CrearRegStock()
       ...
       // GET: ModeloPr/Delete/5
        ...
        public async Task<IActionResult> ProductoConMayorInventario()
        {
            var productoConMayorInventario = await _context.Stokc
                .OrderByDescending(stock => stock.Cantidad)
                .FirstOrDefaultAsync();

            if (productoConMayorInventario == null)
            {
                return NotFound();
            }

            return View(productoConMayorInventario);
        }
